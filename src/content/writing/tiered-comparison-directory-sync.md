...
For cases where correctness has to be certain — the `verify` command — the tool skips the fast tiers entirely and always hashes. Different commands, different tradeoffs, same underlying comparison logic.
