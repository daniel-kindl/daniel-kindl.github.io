...
See a [passing production run](https://github.com/daniel-kindl/daniel-kindl.github.io/actions/runs/30526223284). The script budget is the one that shapes decisions most: it rules out shipping a framework to render text, so the site's client-side behavior stays framework-free and narrowly scoped.
